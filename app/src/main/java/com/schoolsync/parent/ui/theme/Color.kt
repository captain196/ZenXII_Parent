...
// ─── DARK PALETTE — Parent App (slate / cyan) ────────────────────────────────
// Ported from SchoolSync-ParentApp-2.html (D object).
val DarkColors = AppColors(
    ...
    attHoliday = Color(0xFF7FB3E0),
    attVacation = Color(0xFFB49AEF),
    surfaceDark = Color(0xFF0E1822),
    ...
    shimmerBase = Color(0xFF162030),
    shimmerHighlight = Color(0xFF1A2838),
...
// ─── LIGHT PALETTE — Parent App (slate / cool blue) ──────────────────────────
// Ported from SchoolSync-ParentApp-2.html (L object).
val LightColors = AppColors(
    isDark = false,
    bgStart = Color(0xFFC8D8E8),
    bgMid = Color(0xFFE8EEF4),
    bgEnd = Color(0xFFB8CCE0),
    ...
    attHoliday = Color(0xFF2E6BB5),
    attVacation = Color(0xFF6B52C4),
    surfaceDark = Color(0xFFD4DEE8),
    surfaceElevated = Color(0xFFFFFFFF),
    divider = Color(0x08000000),
    navBg = Color(0x59FFFFFF),
    navBorder = Color(0x8CFFFFFF),
    ...
    shimmerBase = Color(0xFFD4DEE8),
    shimmerHighlight = Color(0xFFE8EEF4),
